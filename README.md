...
| [**Warqa**](https://github.com/softglazee/warqa-wordpress-theme) | Block theme. `theme.json` v3, nine templates, 45 patterns, dark variation, bundled fonts. Passed Theme Check across 16,091 tests with zero required and zero warnings | ✅ Live — [wordpress.org/themes/warqa/](https://wordpress.org/themes/warqa/) |
